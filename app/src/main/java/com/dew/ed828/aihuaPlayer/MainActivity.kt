...
import com.dew.ed828.aihuaPlayer.local.fragment.SearchFragment
import com.dew.ed828.aihuaPlayer.local.fragment.VideoDetailFragment
        ...
        try {
            ...
            when {
                intent!!.hasExtra(KEY_LINK_TYPE) -> {
                    ...
                    when (intent.getSerializableExtra(KEY_LINK_TYPE) as StreamingService.LinkType) {
                        ...
                        StreamingService.LinkType.NONE -> {
                            Log.d(TAG, "Error: StreamingService.LinkType is NONE")
                        }
                    }
                }
