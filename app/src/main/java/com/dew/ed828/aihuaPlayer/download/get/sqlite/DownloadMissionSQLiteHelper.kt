 ...
 *
 */
class DownloadMissionSQLiteHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        private const val TAG = "DownloadMissionHelper"
