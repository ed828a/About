package com.dew.ed828.aihuaPlayer.download.model

import android.os.Handler
import android.os.Looper
import android.util.Log
import com.dew.ed828.aihuaPlayer.download.runnable.DownloadRunnable
import com.dew.ed828.aihuaPlayer.download.runnable.DownloadRunnableFallback
...
class DownloadMission : Serializable {
    ...
    val blockState: MutableMap<Long, Boolean> = HashMap()
    ...
    fun notifyProgress(deltaLen: Long) {
        ...
        for (ref in mListeners) {
            ...
            if (listener != null) {
                MissionListener.handlerStore[listener]!!.post {
