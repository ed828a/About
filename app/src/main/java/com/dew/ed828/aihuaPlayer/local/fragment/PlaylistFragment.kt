...
import com.dew.ed828.aihuaPlayer.local.playlist.RemotePlaylistManager
...
import com.dew.ed828.aihuaPlayer.player.playqueue.PlaylistPlayQueue
...
class PlaylistFragment : BaseListInfoFragment<PlaylistInfo>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        remotePlaylistManager = RemotePlaylistManager(EdPlayerDatabase.getInstance(
            requireContext()))
    }
