...
import com.dew.ed828.aihuaPlayer.download.dialog.DownloadDialog
import com.dew.ed828.aihuaPlayer.fragments.BaseFragment
import com.dew.ed828.aihuaPlayer.fragments.BaseStateFragment
import com.dew.ed828.aihuaPlayer.fragments.common.BackPressable
import com.dew.ed828.aihuaPlayer.infolist.builder.InfoItemBuilder
import com.dew.ed828.aihuaPlayer.infolist.dialog.InfoItemDialog
...
import com.dew.ed828.aihuaPlayer.local.model.StackItem
...
import com.dew.ed828.aihuaPlayer.player.MainVideoPlayerActivity
import com.dew.ed828.aihuaPlayer.player.PopupVideoPlayer
import com.dew.ed828.aihuaPlayer.player.activity.PlayVideoActivity
import com.dew.ed828.aihuaPlayer.player.playqueue.SinglePlayQueue
...
class VideoDetailFragment : BaseStateFragment<StreamInfo>(), BackPressable, SharedPreferences.OnSharedPreferenceChangeListener, View.OnClickListener, View.OnLongClickListener {
    ...
    override fun initViews(rootView: View, savedInstanceState: Bundle?) {
        ...
        spinnerToolbar = activity!!.findViewById<View>(R.id.toolbar).findViewById(R.id.toolbarSpinner)
    ...
    private fun setupActionBar(info: StreamInfo) {
        ...
        val streamsAdapter = StreamItemAdapter(activity!!,
            StreamItemAdapter.StreamSizeWrapper(sortedVideoStreams!!), isExternalPlayerEnabled)
