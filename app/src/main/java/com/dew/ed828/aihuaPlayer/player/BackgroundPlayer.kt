...
import com.dew.ed828.aihuaPlayer.player.Helper.LockManager
import com.dew.ed828.aihuaPlayer.player.Helper.PlayerHelper.getTimeString
import com.dew.ed828.aihuaPlayer.player.playqueue.PlayQueueItem
import com.dew.ed828.aihuaPlayer.player.resolver.AudioPlaybackResolver
...
class BackgroundPlayer : Service() {
    ...
    override fun onCreate() {
        ...
        if (basePlayerImpl == null) {
            throw RuntimeException("creating BasePlayerImpl failed.")
        }
    ...
    companion object {
        ...
        const val ACTION_CLOSE = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.CLOSE"
        const val ACTION_PLAY_PAUSE = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.PLAY_PAUSE"
        const val ACTION_REPEAT = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.REPEAT"
        const val ACTION_PLAY_NEXT = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.ACTION_PLAY_NEXT"
        const val ACTION_PLAY_PREVIOUS = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.ACTION_PLAY_PREVIOUS"
        const val ACTION_FAST_REWIND = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.ACTION_FAST_REWIND"
        const val ACTION_FAST_FORWARD = "com.dew.ed828.aihuaPlayer.player.BackgroundPlayer.ACTION_FAST_FORWARD"
