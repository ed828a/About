...
import com.dew.ed828.aihuaPlayer.fragments.BlankFragment
...
abstract class Tab {
    ...
    class HistoryTab : Tab() {
        ...
        override val fragment: HistoryPlaylistFragment
            get() = HistoryPlaylistFragment()
    ...
    companion object {
        protected val TAG = this::class.java.simpleName + "@" + Integer.toHexString(hashCode())
